...
void display_log(GLuint object, void (*param_func)(), void (*getlog_func)())
{
  ...
  param_func(object, GL_LOG_LENGTH, &log_length);
...
int mlx_shaders_pixel(glsl_t *glsl)
{
  char  *source;
  int	length;
  GLint action_ok;
...
int mlx_shaders_image(glsl_t *glsl)
{
  char  *source;
  int	length;
  GLint action_ok;
...
int mlx_shaders_font(glsl_t *glsl)
{
  char  *source;
  int	length;
  GLint action_ok;
