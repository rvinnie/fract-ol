...
int	mipng_fill_img(mlx_img_list_t *img, unsigned char *buf, png_t *pi)
{
...
int	mipng_data(mlx_img_list_t *img, unsigned char *dat, png_t *pi)
{
  unsigned int	len;
  int		b_pos;
...
int	mipng_verif_hdr(unsigned char *hdr, png_t *pi)
{
